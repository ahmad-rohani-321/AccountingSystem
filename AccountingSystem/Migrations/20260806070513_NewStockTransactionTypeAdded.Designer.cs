...
namespace AccountingSystem.Migrations
{
    ...
    [Migration("20260806070513_NewStockTransactionTypeAdded")]
    partial class NewStockTransactionTypeAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountingSystem.Models.Accounts.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2026, 8, 6, 11, 35, 10, 149, DateTimeKind.Local).AddTicks(6309),
                            IsActive = true,
                            Name = "عادي"
                        });
                });
            ...
            modelBuilder.Entity("AccountingSystem.Models.Accounts.AccountContacts", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "",
                            CreatedByUserId = "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01",
                            CreationDate = new DateTime(2026, 8, 6, 11, 35, 10, 149, DateTimeKind.Local).AddTicks(8193),
                            Email = "",
                            FirstPhone = "",
                            NIC = "",
                            SecondPhone = ""
            ...
            modelBuilder.Entity("AccountingSystem.Models.Identity.Role", b =>
                {
            ...
            modelBuilder.Entity("AccountingSystem.Models.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEM2Z04MCXNIn4gGAlFmTuCyyqjYL233b6v5HPoWEcFRA9lKHNMhrkA4EoCCYJ+SOiA==",
            ...
            modelBuilder.Entity("AccountingSystem.Models.Identity.UserHistory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AccountingSystem.Models.Identity.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2026, 8, 6, 11, 35, 10, 147, DateTimeKind.Local).AddTicks(3059)
                        });
                });
            ...
            modelBuilder.Entity("AccountingSystem.Models.Inventory.ItemPrice", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AccountingSystem.Models.Inventory.WareHouse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            CreatedByUserId = "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01",
                            CreationDate = new DateTime(2026, 8, 6, 11, 35, 10, 149, DateTimeKind.Local).AddTicks(1585),
            ...
            modelBuilder.Entity("AccountingSystem.Models.Purchase.Purchase", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AccountingSystem.Models.Purchase.PurchaseDetails", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AccountingSystem.Models.Purchase.PurchaseExpences", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AccountingSystem.Models.Purchase.PurchaseExpenseDetails", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal>("PerExpense")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("PerTamamShud")
                        .HasColumnType("TEXT");

                    b.Property<int>("PurchaseDetailItemID")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal>("TotalTamamShud")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("PurchaseDetailItemID");

                    b.HasIndex("PurchaseExpenseID");

                    b.ToTable("PurchaseExpenseDetails");
                });

            modelBuilder.Entity("AccountingSystem.Models.Purchase.PurchaseOrder", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AccountingSystem.Models.Purchase.PurchaseOrderDetails", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AccountingSystem.Models.Purchase.PurchaseVariousExpenses", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("PurchaseVariousExpenses");
                });
            ...
            modelBuilder.Entity("AccountingSystem.Models.Settings.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            CreatedByUserId = "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01",
                            CreationDate = new DateTime(2026, 8, 6, 11, 35, 10, 150, DateTimeKind.Local).AddTicks(3602),
                            CurrencyName = "افغانۍ",
                            CurrencySymbole = "AFN",
                            IsActive = true,
                            IsMainCurrency = true
                        ...
                        new
                        {
                            ID = 2,
                            CreatedByUserId = "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01",
                            CreationDate = new DateTime(2026, 8, 6, 11, 35, 10, 150, DateTimeKind.Local).AddTicks(3614),
                            CurrencyName = "ډالر",
                            CurrencySymbole = "USD",
                            IsActive = true,
            ...
            modelBuilder.Entity("AccountingSystem.Models.Identity.UserRole", b =>
                {
                    b.HasOne("AccountingSystem.Models.Identity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AccountingSystem.Models.Purchase.PurchaseExpenseDetails", b =>
                {
                    ...
                    b.HasOne("AccountingSystem.Models.Purchase.PurchaseDetails", "PurchaseDetails")
                        .WithMany()
                        .HasForeignKey("PurchaseDetailItemID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AccountingSystem.Models.Purchase.PurchaseExpences", "PurchaseExpense")
                        .WithMany()
                        .HasForeignKey("PurchaseExpenseID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
