        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PashtoName = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01", 0, "7a3c2e1d-9b8a-4f6e-8c2b-5d4f3a2b1c9e", "admin@admin.com", true, "Admin", true, "admin", false, null, "ADMIN@ADMIN.COM", "ADMIN", "AQAAAAIAAYagAAAAEH2wmwLk+vCFBGUI6gDPM9W6NuoA1o7Zf5Cocp8Va+HAEhKwdB/h612z8yQW4dyBqQ==", null, false, "", "2c9a4d9b-4f5a-4b8b-9a7c-2b1c3d4e5f61", false, "admin" });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "ID", "AccountTypeID", "Code", "CreatedByUserId", "CreationDate", "IsActive", "Name" },
                values: new object[] { 1, 10, "Walkin", "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01", new DateTime(2026, 7, 13, 18, 35, 6, 486, DateTimeKind.Local).AddTicks(9269), true, "عادي" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01", new DateTime(2026, 7, 13, 18, 35, 6, 487, DateTimeKind.Local).AddTicks(5414), "افغانۍ", "AFN", true, true },
                    { 2, "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01", new DateTime(2026, 7, 13, 18, 35, 6, 487, DateTimeKind.Local).AddTicks(5422), "ډالر", "USD", true, false }
                });

            migrationBuilder.InsertData(
                table: "UserRole",
                columns: new[] { "RoleId", "UserId", "CreationDate" },
                values: new object[] { "65a02658-9b8d-4505-95af-5edd8634bb35", "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01", new DateTime(2026, 7, 13, 18, 35, 6, 484, DateTimeKind.Local).AddTicks(8464) });

            migrationBuilder.InsertData(
                table: "WareHouses",
                columns: new[] { "ID", "CreatedByUserId", "CreationDate", "Description", "IsActive", "Name" },
                values: new object[] { 1, "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01", new DateTime(2026, 7, 13, 18, 35, 6, 486, DateTimeKind.Local).AddTicks(4773), "اصلي ګدام د ټولو موادو لپاره دی.", true, "عمومي ګدام" });

            migrationBuilder.InsertData(
                table: "AccountContacts",
                columns: new[] { "ID", "AccountID", "Address", "CreatedByUserId", "CreationDate", "Email", "FirstPhone", "NIC", "SecondPhone" },
                values: new object[] { 1, 1, "", "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01", new DateTime(2026, 7, 13, 18, 35, 6, 487, DateTimeKind.Local).AddTicks(840), "", "", "", "" });
