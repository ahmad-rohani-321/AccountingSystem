...
namespace AccountingSystem.Migrations
{
    ...
    [Migration("20260907072519_StockBalanceAddedToSaleDetails")]
    partial class StockBalanceAddedToSaleDetails
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AccountingSystem.Models.Accounts.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2026, 9, 7, 11, 55, 17, 171, DateTimeKind.Local).AddTicks(8468),
                            IsActive = true,
                            Name = "عادي"
                        });
                });
            ...
            modelBuilder.Entity("AccountingSystem.Models.Accounts.AccountContacts", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "",
                            CreatedByUserId = "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01",
                            CreationDate = new DateTime(2026, 9, 7, 11, 55, 17, 172, DateTimeKind.Local).AddTicks(73),
                            Email = "",
                            FirstPhone = "",
                            NIC = "",
                            SecondPhone = ""
            ...
            modelBuilder.Entity("AccountingSystem.Models.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMlu5Mg9aInQz2ZXe0yAnnM9vbYWfUW+PiHBxu+izYkggIG1nYGb/7VCbgdKliua6w==",
            ...
            modelBuilder.Entity("AccountingSystem.Models.Identity.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2026, 9, 7, 11, 55, 17, 169, DateTimeKind.Local).AddTicks(6035)
                        });
                });
            ...
            modelBuilder.Entity("AccountingSystem.Models.Inventory.StockBalance", b =>
                {
                    ...
                    b.Property<decimal>("PurchaseBaseCurrencyPrice")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AccountingSystem.Models.Inventory.WareHouse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            CreatedByUserId = "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01",
                            CreationDate = new DateTime(2026, 9, 7, 11, 55, 17, 171, DateTimeKind.Local).AddTicks(4504),
            ...
            modelBuilder.Entity("AccountingSystem.Models.Settings.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            CreatedByUserId = "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01",
                            CreationDate = new DateTime(2026, 9, 7, 11, 55, 17, 172, DateTimeKind.Local).AddTicks(4620),
                            CurrencyName = "افغانۍ",
                            CurrencySymbole = "AFN",
                            IsActive = true,
                            IsMainCurrency = true
                        ...
                        new
                        {
                            ID = 2,
                            CreatedByUserId = "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01",
                            CreationDate = new DateTime(2026, 9, 7, 11, 55, 17, 172, DateTimeKind.Local).AddTicks(4628),
                            CurrencyName = "ډالر",
                            CurrencySymbole = "USD",
                            IsActive = true,
            ...
            modelBuilder.Entity("AccountingSystem.Models.Sales.SaleDetails", b =>
                {
                    ...
                    b.HasOne("AccountingSystem.Models.Inventory.StockBalance", "StockItem")
                        .WithMany()
