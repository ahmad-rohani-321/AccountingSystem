...
namespace AccountingSystem.Migrations
{
    ...
    [Migration("20260819052611_SaleAndPurchaseEdit")]
    partial class SaleAndPurchaseEdit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AccountingSystem.Models.Accounts.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2026, 8, 19, 9, 56, 9, 88, DateTimeKind.Local).AddTicks(2423),
                            IsActive = true,
                            Name = "عادي"
                        });
                });
            ...
            modelBuilder.Entity("AccountingSystem.Models.Accounts.AccountContacts", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "",
                            CreatedByUserId = "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01",
                            CreationDate = new DateTime(2026, 8, 19, 9, 56, 9, 88, DateTimeKind.Local).AddTicks(3966),
                            Email = "",
                            FirstPhone = "",
                            NIC = "",
                            SecondPhone = ""
            ...
            modelBuilder.Entity("AccountingSystem.Models.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEO8oHjHEBEcGEmqCiKYFDSfzpEFVNHFFbybt0cPY+REOtAJYZQLPRoBHmgU8pV+j7A==",
            ...
            modelBuilder.Entity("AccountingSystem.Models.Identity.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2026, 8, 19, 9, 56, 9, 86, DateTimeKind.Local).AddTicks(584)
                        });
                });
            ...
            modelBuilder.Entity("AccountingSystem.Models.Inventory.WareHouse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            CreatedByUserId = "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01",
                            CreationDate = new DateTime(2026, 8, 19, 9, 56, 9, 87, DateTimeKind.Local).AddTicks(7798),
            ...
            modelBuilder.Entity("AccountingSystem.Models.Purchase.Purchase", b =>
                {
                    ...
                    b.Property<bool>("CanAffectStock")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AccountingSystem.Models.Settings.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            CreatedByUserId = "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01",
                            CreationDate = new DateTime(2026, 8, 19, 9, 56, 9, 88, DateTimeKind.Local).AddTicks(8944),
                            CurrencyName = "افغانۍ",
                            CurrencySymbole = "AFN",
                            IsActive = true,
                            IsMainCurrency = true
                        ...
                        new
                        {
                            ID = 2,
                            CreatedByUserId = "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01",
                            CreationDate = new DateTime(2026, 8, 19, 9, 56, 9, 88, DateTimeKind.Local).AddTicks(8952),
                            CurrencyName = "ډالر",
                            CurrencySymbole = "USD",
                            IsActive = true,
