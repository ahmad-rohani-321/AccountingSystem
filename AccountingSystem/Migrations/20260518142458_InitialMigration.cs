    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01", 0, "7a3c2e1d-9b8a-4f6e-8c2b-5d4f3a2b1c9e", "admin", true, "admin", "admin", false, null, "ADMIN", "ADMIN", "AQAAAAIAAYagAAAAEHup71IP4XlSEPSDgiL+9fLGGDOdq/QBvjd3R9aBUgaxg6JyqBB91IPG25GT+D+bWQ==", null, false, "", "2c9a4d9b-4f5a-4b8b-9a7c-2b1c3d4e5f61", false, "admin" });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "ID", "AccountTypeID", "Code", "CreatedByUserId", "CreationDate", "IsActive", "Name" },
                values: new object[] { 1, 10, "Walkin", "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01", new DateTime(2026, 5, 18, 18, 54, 57, 653, DateTimeKind.Local).AddTicks(3244), true, "عادي" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01", new DateTime(2026, 5, 18, 18, 54, 57, 654, DateTimeKind.Local).AddTicks(478), "افغانۍ", "AFN", true, true },
                    { 2, "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01", new DateTime(2026, 5, 18, 18, 54, 57, 654, DateTimeKind.Local).AddTicks(488), "ډالر", "USD", true, false }
                });

            migrationBuilder.InsertData(
                table: "WareHouses",
                columns: new[] { "ID", "CreatedByUserId", "CreationDate", "Description", "IsActive", "Name" },
                values: new object[] { 1, "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01", new DateTime(2026, 5, 18, 18, 54, 57, 651, DateTimeKind.Local).AddTicks(3625), "اصلي ګدام د ټولو موادو لپاره دی.", true, "عمومي ګدام" });

            migrationBuilder.InsertData(
                table: "AccountContacts",
                columns: new[] { "ID", "AccountID", "Address", "CreatedByUserId", "CreationDate", "Email", "FirstPhone", "NIC", "SecondPhone" },
                values: new object[] { 1, 1, "", "f5b9b7e7-2d3a-4b4d-a1b5-1b3f2a7a9e01", new DateTime(2026, 5, 18, 18, 54, 57, 653, DateTimeKind.Local).AddTicks(5438), "", "", "", "" });
